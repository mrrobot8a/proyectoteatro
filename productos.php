<div class="row mt-1">
    ...
    $where = " where 1=1 and p.idTipo = 1 ";
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="card border-primary">
                ...
                <div class="card-body">
                    ...
                    <?php 
                    ?>
                    <a href="index.php?modulo=detalleproducto&id=<?php echo $row['id'] ?>&nombre=<?php echo $row['nombre'] ?>&page=<?php echo $_REQUEST['page'] ?>" class="btn btn-primary">Ver</a>
                </div>
            </div>
        </div>
    <?php
