    ...
    <div class="card-body">
        <div class="row">
            <div class="col-12 col-sm-6">
                <h3 class="d-inline-block d-sm-none"><?php echo $rowProducto['nombreSala'] ?></h3>
                <?php
      ...
      $resD = mysqli_query($con, $queryF);
?>
 <select class="form-control" name="Codigo" id="SelectCantidad" type="reset">
    ...
    <?php endfor;?>
     ...
     <script>
        ...
        <div class="row mt-4">
            ...
            <div class="tab-pane fade show active" id="product-desc" role="tabpanel" aria-labelledby="product-desc-tab">  <p  class="my-2" ><?php echo $rowProducto['aqui'] ?></p></div>
            <div class="tab-pane fade" id="product-comments" role="tabpanel" aria-labelledby="product-comments-tab"> Recargo nocturno (aplica para eventos, grabaciones y uso de espacios después de las 10:00 p.m.): 1 SMMLV  más IVA.  </div>
