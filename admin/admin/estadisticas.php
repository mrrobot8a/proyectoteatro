...
$queryProdmax="SELECT  productos.idTipo,detalleventa.idProd,productos.nombre, COUNT( detalleventa.idProd ) AS total
FROM detalleventa INNER JOIN productos ON productos.id = detalleventa.idProd 
GROUP BY detalleventa.idProd
ORDER BY total DESC; ";
$resProdmax=mysqli_query($con,$queryProdmax);
$rowPromax=mysqli_fetch_assoc($resProdmax);
$data = array();

$queryProdmin="SELECT productos.idTipo,detalleventa.idProd,productos.nombre, COUNT( detalleventa.idProd ) AS total
FROM detalleventa INNER JOIN productos ON productos.id = detalleventa.idProd 
GROUP BY detalleventa.idProd
ORDER BY total ASC; ";
$resProdmin=mysqli_query($con,$queryProdmin);
$rowPromin=mysqli_fetch_assoc($resProdmin);
$data = array();
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-4">
              ...
              <div class="small-box bg-info">
                <div class="inner">
                  <h3><?php echo $rowPromax['nombre']; ?></h3>
                  <p><?php if($rowPromax['idTipo']=='3'){
                     echo "tipo producto SALA Producto mas solicitado";
                  }else if($rowPromax['idTipo']=='2'){ 
                    echo "tipo producto colon Escolar Producto mas solicitado";
                  }else{
                    echo "tipo producto Obra Producto mas solicitado";
                  } ?></p>
                </div>
                <div class="icon">
                  <i class="ion ion-bag"></i>
            ...
            <div class="col-6">
              ...
              <div class="small-box bg-warning">
                <div class="inner">
                  <h3><?php  echo $rowPromin['nombre'] ;  $rowPromin['nombre']; ?></h3>
                  <p><?php if($rowPromin['idTipo']=='3'){
                     echo "tipo producto SALA Producto menos solicitado";
                  }else if($rowPromin['idTipo']=='2'){ 
                    echo "tipo producto colon Escolar Producto menos solicitado";
                  }else{
                    echo "tipo producto Obra Producto menos solicitado";
                  } ?></p>
