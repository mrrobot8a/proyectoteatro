...
$queryCuenta = "SELECT COUNT(*) as cuenta FROM ventas;";
...
<div>
    ...
    Teatri colon N°<?php echo $totalRegistros+1?> DE FACTURA
</div>
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td><?php echo "$".number_format($row['subTotal']/100); ?></td>
                <td>PAGADO</td>
            </tr>
        <?php
        }
        ...
        <tr>
            ...
            <td><?php echo "$".number_format($total/100); ?></td>
        </tr>
