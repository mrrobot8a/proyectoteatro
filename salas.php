<div class="row mt-1">
    ...
    $where = " where 1=1 and p.idTipo = 3 ";
    ...
    ?>
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="card border-primary">
                ...
                <div class="card-body">
                    <h2 class="card-title"><strong>Nombre <?php echo $row['nombre'] ?></strong></h2>
                    ...
                    <?php 
                    ?>
                    <a href="index.php?modulo=detallesSalas&id=<?php echo $row['id'] ?>&nombre=<?php echo $row['nombre'] ?>&page=1" class="btn btn-primary">Ver</a>
                </div>
            </div>
        </div>
    <?php
